...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="#"><b>@lang('site.login')</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
           
            <p class="login-box-msg">@lang('site.hello_Control_system')</p>
            <p class="login-box-msg">@lang('site.email') : doc@admin.com</p>
            <p class="login-box-msg">@lang('site.password') : 55555</p>

            <form method="POST" action="{{ route('login') }}">
                @csrf
                <div class="form-group has-feedback">
                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="@lang('site.email')" name="email" value="{{ old('email') }}" required autofocus>
                ...
                <div class="form-group has-feedback">
                    <input id="password" placeholder="@lang('site.password')" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
