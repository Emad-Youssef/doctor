...
@section('content')
    ...
    <section class="content">
        <div class="box">
                ...
                <form class="news-ajax" data-route="{{ route('dashboard.news.store') }}" method="post" data-token="{{ csrf_token() }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col col-md-6">
                            ...
                            <textarea class="form-control" name="ar[description]"></textarea>
                        </div>

                        <div class="form-group col col-md-6">
                            <label >@lang('site.en_description')</label>
                            <span id="en_description_div_inside" class="inside-empty"></span>
                            <textarea class="form-control" name="en[description]"></textarea>
                        </div>
                        ...
                        <div class="form-group col col-md-6">
                            ...
                            <img src="{{ asset('uploads/news/new.jpg')}}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
                        <div class="form-group col col-md-6">
