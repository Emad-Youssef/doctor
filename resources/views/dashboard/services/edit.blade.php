...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="#"><a href="{{ route('dashboard.service.index') }}">@lang('site.services')</a></li>
    ...
    <section class="content">
        <div class="box">
                ...
                <form class="news-ajax" data-route="{{ route('dashboard.service.update',$service->id ) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col col-md-6">
                            <label >@lang('site.ar_title')</label>
                            <span id="ar_title_div_inside" class="inside-empty"></span>
                            <input id="ar_title_input_inside" type="text" name="ar[title]" value="{{ $service->translate('ar')->title }}" class="form-control"  placeholder="@lang('site.ar_title')">
                        </div>

                        <div class="form-group col col-md-6">
                            <label >@lang('site.en_title')</label>
                            <span id="en_title_div_inside" class="inside-empty"></span>
                            <input id="en_title_input_inside" type="text" name="en[title]" value="{{ $service->translate('en')->title }}" class="form-control"  placeholder="@lang('site.en_title')">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col col-md-6">
                            ...
                            <input id="ar_description_input_inside" type="text" name="ar[description]" value="{{ $service->translate('ar')->description }}" class="form-control"  placeholder="@lang('site.ar_description')">
                        </div>

                        <div class="form-group col col-md-6">
                            <label >@lang('site.en_description')</label>
                            <span id="en_description_div_inside" class="inside-empty"></span>
                            <input id="en_description_input_inside" type="text" name="en[description]" value="{{ $service->translate('en')->description }}" class="form-control"  placeholder="@lang('site.en_description')">
                        </div>
                        ...
                        <div class="form-group col col-md-6">
                            ...
                            <img src="{{ asset('uploads/'.$service->img) }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
