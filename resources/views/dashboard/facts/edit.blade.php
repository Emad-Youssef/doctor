...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="#"><a href="{{ route('dashboard.numberFact.index') }}">@lang('site.numberFacts')</a></li>
    ...
    <section class="content">
        <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form class="news-ajax" data-route="{{ route('dashboard.numberFact.update',$fact->id ) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="form-group col col-md-6">
                                <label >@lang('site.ar_title')</label>
                                <span id="ar_title_div_inside" class="inside-empty"></span>
                                <input id="ar_title_input_inside"  type="text" name="ar[title]" value="{{ $fact->translate('ar')->title }}" class="form-control"  placeholder="@lang('site.ar_title')">
                            </div>

                            <div class="form-group col col-md-6">
                                <label >@lang('site.en_title')</label>
                                <span id="en_title_div_inside" class="inside-empty"></span>
                                <input id="en_title_input_inside"  type="text" name="en[title]" value="{{ $fact->translate('en')->title }}" class="form-control"  placeholder="@lang('site.en_title')">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col col-md-6">
                                ...
                                <span id="number_div_inside" class="inside-empty"></span>
                                <input id="number_input_inside"  type="text" name="number" class="form-control" value="{{ $fact->number }}"  placeholder="@lang('site.number')">
                            </div>
                            ...
                            <div class="form-group col col-md-6">
                                ...
                                <img src="{{ asset('uploads/'.$fact->img) }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                            </div>
            ...
            success : function(data){
                if(data.status === 0)
                {
                    ...
                    $.each( data.message, function( key, value ) {
                        ...
                        if(key == 'number'){
                            $('#number_div_inside').empty()
                            $('#number_input_inside').addClass('has-error')
                            $('#number_div_inside').append('<small class="has-val">'+value+'</small>');
                        }
