...
@section('content')
    ...
    <section class="content">
        <div class="box">
                ...
                <form class="news-ajax" data-route="{{ route('dashboard.numberFact.store') }}" method="post" data-token="{{ csrf_token() }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col col-md-6">
                            ...
                            <input id="number_input_inside" type="text" name="number" class="form-control"  placeholder="@lang('site.number')">
                        </div>
                        <div class="form-group col col-md-6">
