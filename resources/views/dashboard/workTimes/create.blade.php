...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="#"><a href="{{ route('dashboard.workTime.index') }}">@lang('site.workTime')</a></li>
    ...
    <section class="content">
        <div class="box">
                ...
                <form class="work-ajax" data-route="{{ route('dashboard.workTime.store') }}" method="post" data-token="{{ csrf_token() }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col col-md-6">
                            <label >@lang('site.ar_day')</label>
                            <span id="ar_day_div_inside" class="inside-empty"></span>
                            <input id="ar_day_input_inside" type="text" name="ar[day]" class="form-control"  placeholder="@lang('site.ar_day')">
                        </div>

                        <div class="form-group col col-md-6">
                            <label >@lang('site.en_day')</label>
                            <span id="en_day_div_inside" class="inside-empty"></span>
                            <input id="en_day_input_inside" type="text" name="en[day]" class="form-control"  placeholder="@lang('site.en_day')">
                        </div>
                    </div>
