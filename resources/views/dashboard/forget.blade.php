...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ route('dashboard.login') }}"><b>@lang('site.login')</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="{{ route('dashboard.forget') }}" method="post">
        @csrf
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('site.send')</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
