...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="#"><a href="{{ route('dashboard.users.index') }}">@lang('site.user')</a></li>
    ...
    <section class="content">
        <div class="box">
                ...
                <form class="form-ajax" data-route="{{ route('dashboard.users.update',$user->id ) }}" method="post"">
                    @csrf
                    <div class="row">
                        <div class="form-group col col-md-6">
                            <label>@lang('site.doctor')</label>
                            <input type="text" class="form-control" disabled="disabled" value="{{$user->employee->f_name}} {{$user->employee->l_name}}">
                        </div>

                        <div class="form-group col col-md-6">
                            <label>@lang('site.img')</label>
                            <input type="file" name="img" class="form-control image"  placeholder="@lang('site.img')">
                            <img src="{{ $user->img_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>

                        <div class="form-group col col-md-6">
                            <label for="exampleInputEmail">@lang('site.email')</label>
                            <input type="email" name="email" class="form-control" id="exampleInputEmail" placeholder="@lang('site.email')" value="{{ $user->email }}">
                        </div>
                    </div>
