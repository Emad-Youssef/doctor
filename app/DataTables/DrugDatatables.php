...
class DrugDatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'dashboard.drugs.btn.check')
            ->addColumn('action', 'dashboard.drugs.btn.button')
    ...
    {
        return $this->builder()
                    ->setTableId('drugdatatables-table')
    ...
    {
        return 'DrugDatatables_' . date('YmdHis');
    }
}
