...
class ServiceDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'dashboard.services.btn.button')
            ->addColumn('img', 'dashboard.services.btn.img')
    ...
    {
        return $this->builder()
                    ->setTableId('servicedatatables-table')
    ...
    {
        return 'ServiceDatatables_' . date('YmdHis');
    }
}
